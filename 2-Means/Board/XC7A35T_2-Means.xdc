...
## LEDs
set_property PACKAGE_PIN P3 [get_ports {sbits[3]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {sbits[3]}]
set_property PACKAGE_PIN N3 [get_ports {sbits[2]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {sbits[2]}]
